    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return fetch(url)
            ...
            const nextOrders = payload.data
                ...
                .sort((a, b) => Date.parse(b.deliveryTime.deliveryStart) -
...
function buildOrderHistory(orderIds) {
    return __awaiter(this, void 0, void 0, function* () {
        const orders = orderIds.map((id) => __awaiter(this, void 0, void 0, function* () {
            return yield fetchOrder(id);
        }));
        return yield Promise.all(orders);
    });
}
const orderHistoryX = [
    {
...
function buildProposals() {
    return __awaiter(this, void 0, void 0, function* () {
        const orderIds = yield fetchOrders();
        const orderHistory = yield buildOrderHistory(orderIds.processed);
        const nextOrderDateString = (yield fetchOrder(orderIds.next)).deliveryAt;
        const nextOrderDate = nextOrderDateString ? new Date(Date.parse(nextOrderDateString)) : new Date();
        ...
        return proposedItems(nextOrderDate, itemHistories, itemFrequencies, orderDates);
    });
}
...
function updateUI(itemsForNextOrder) {
    ...
    const currentShoppingItems = Array.from(document.querySelectorAll(".shopping-list-item .product-result-name-content .product-name SPAN"))
        .map(it => it.innerHTML);
    const itemsToPropose = itemsForNextOrder.filter(it => currentShoppingItems.indexOf(it) === -1);
...
//# sourceMappingURL=smartcart.js.map